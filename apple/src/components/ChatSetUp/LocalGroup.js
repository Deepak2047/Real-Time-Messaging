      ...
      <Modal onClose={onClose} isOpen={isOpen} isCentered>
        ...
        <ModalContent>
          ...
          <ModalBody display="flex" flexDir="column" alignItems="center">
            ...
            <FormControl>
              <Input
                placeholder="Add Users eg: Harsh , Ajeet , Piyush"
                mb={1}
              ...
              searchResult
                ...
                .map((user) => (
                  <UserSeq
                    key={user._id}
                    user={user}
                    handleFunction={() => UserGroup(user)}
                  />
                ))
            )}
          </ModalBody>
          <ModalFooter>
            <Button onClick={UserSubmit} colorScheme="blue">
              Create Chat
            </Button>
          </ModalFooter>
        </ModalContent>
