...
import UserIcon from "../GroupItem/UserIcon";
import UserSeq from "../GroupItem/UserSeq";
import { ChatState } from "../../Context/ChatC";
import axios from "axios";

const UGroup = ({ fetchMessages, fetchAgain, setFetchAgain }) => {
  ...
  return (
    <>
      ...
      <Modal onClose={onClose} isOpen={isOpen} isCentered>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader fontSize="24px" display="flex" justifyContent="center">
